...
@section('title', 'Himnario Oficial')

@section('page-name')
    @php
        $page_menu = 'himnario';
        $page_submenu = 'himnario';
    @endphp
@endsection
...
@section('content')
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            @can('crear-alabanzas-himnario')
                <button id="btn-nuevo-himnario" class="btn btn-primary">Nuevo</button><br><br>
            @endcan

            <table id="t-himnario" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>Num Himnario</th>
                        <th>Nombre</th>
...
@section('modals')
    <!-- CREAR Y EDITAR -->
    <div class="modal fade" id="modal-himnario" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="form-himnario">
                    <input type="hidden" value="0" name="idHimnario" id="idHimnario">
                    <!--Modal body-->
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label class="control-label" for="numero_himnario">Número Himnario (*)</label>
                                    <input type="number" id="numero_himnario" name="numero_himnario" class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-9">
                                <div class="form-group">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="eliminarAlabanzaHimnario();"
...
@section('page-js')
    <script src="{{ asset('js-content/himnario.js') }}"></script>
@endsection
