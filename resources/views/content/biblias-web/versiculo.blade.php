...
@section('content')
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <div class="row">
                <a title="Volver al capítulo"
                    href="{{ route('biblia.libro', ['numero' => $numLibro, 'page' => $numCapitulo]) }}"
                    class="btn btn-primary btn-icon btn-circle"><i class="fa fa-long-arrow-left"></i></a>

                {{-- Botón Anterior --}}
                <a title="Anterior versículo" href="{{ $versiculosPaginados->previousPageUrl() }}"
                    class="btn btn-primary btn-icon btn-circle {{ $versiculosPaginados->onFirstPage() ? ' disabled' : '' }}">
                    <i class="fa fa-arrow-left"></i>
                </a>

                {{-- Botón Siguiente --}}
                <a title="Siguiente versículo" href="{{ $versiculosPaginados->nextPageUrl() }}"
