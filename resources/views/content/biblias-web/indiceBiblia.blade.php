...
@section('title', 'Índice Biblia RV1960')
        ...
        <div class="col-lg-12">
            <div class="tab-base">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a data-toggle="tab" href="#demo-lft-tab-1"><b>Antiguo</b> <span
                                class="badge badge-primary">AT</span></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-lft-tab-2"><b>Nuevo</b> <span
                            ...
                            @foreach ($indiceBibliaArray as $libro)
                                @if ($libro['numero'] >= 1 && $libro['numero'] <= 39)
                                    <a class="list-group-item"
                                        href="{{ route('biblia.libro', ['numero' => $libro['numero'], 'page' => 1]) }}">{{ $libro['titulo'] }}</a>
